    ...
    <footer className="bg-brand-dark text-white pt-12 pb-6 sm:pt-16 sm:pb-8">
      <div className="container-main">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-syne text-xl font-extrabold">
                Solutions Plus <span className="text-blue-600">Électrique</span>
              </span>
            </Link>

            <p className="text-neutral-400 text-sm mb-4 max-w-xs leading-relaxed">
              Des services électriques professionnels en qui vous pouvez avoir confiance. Des techniciens
              agréés et assurés, prêts à vous aider 24/7.
            </p>

            <div className="space-y-2 text-sm">
              <p>866-399-2885</p>
              <p>contact@solutionspluselectrique.ca</p>
            </div>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a href="#" aria-label="Facebook" className="text-neutral-400 hover:text-blue-600 transition-colors">
                <Facebook size={20} />
              </a>
              <a href="#" aria-label="Twitter" className="text-neutral-400 hover:text-blue-600 transition-colors">
                <Twitter size={20} />
              </a>
              <a href="#" aria-label="LinkedIn" className="text-neutral-400 hover:text-blue-600 transition-colors">
                <Linkedin size={20} />
              </a>
            </div>
        ...
        <div className="border-t border-neutral-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-neutral-400 text-sm">
            Conçu avec soin par <span className="text-blue-600">Solutions Plus Électrique</span> © 2025
          </p>
          <button
            onClick={scrollToTop}
