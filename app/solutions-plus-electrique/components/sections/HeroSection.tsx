...
import { RESIDENTIAL_SERVICES, COMMERCIAL_SERVICES } from '../../../elumina/data/electric-content'
      ...
      <div className="container-main">
        <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            >
              Des pannes aux mises à niveau, Solutions Plus Électrique se présente à l’heure et laisse votre
              installation sécuritaire. Au service des propriétaires et des entreprises partout au Canada.
            </motion.p>
